/*!
 * @file  flora_sht20.h
 * @brief  Define infrastructure of flora_sht20 class
 ...
 */
#ifndef __flora_sht20_H__
#define __flora_sht20_H__
...
public:
   ...
   * @return None
   */
  flora_sht20(TwoWire *pWire=&Wire, uint8_t sht20Addr=SHT20_I2C_ADDR);
