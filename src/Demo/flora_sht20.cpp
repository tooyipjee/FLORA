/*!
 * @file  flora_sht20.cpp
 * @brief  Define the basic structure of class flora_sht20
 ...
 * @version  V1.0
 * @date  2021-12-03
 * @url  https://github.com/DFRobot/flora_sht20
 */
#include "flora_sht20.h"

flora_sht20::flora_sht20(TwoWire *pWire, uint8_t sht20Addr)
{
  _addr = sht20Addr;
  _pWire = pWire;
}

void flora_sht20::initSHT20()
{
    _pWire->begin(16,17);
}

float flora_sht20::readHumidity(void)
{
...
float flora_sht20::readTemperature(void)
{
...
void flora_sht20::checkSHT20(void)
{
...
void flora_sht20::setResolution(byte resolution)
{
...
byte flora_sht20::readUserRegister(void)
{
    byte userRegister;
...
void flora_sht20::writeUserRegister(byte val)
{
    _pWire->beginTransmission(_addr);
...
void flora_sht20::showReslut(const char *prefix, int val)
{
    Serial.print(prefix);
    if(val){
        Serial.println("yes");
...
byte flora_sht20::checkCRC(uint16_t message_from_sensor, uint8_t check_value_from_sensor)
{
...
uint16_t flora_sht20::readValue(byte cmd)
{
    _pWire->beginTransmission(_addr);
    _pWire->write(cmd);
